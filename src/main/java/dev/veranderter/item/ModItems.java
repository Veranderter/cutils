...
import dev.veranderter.item.custom.DiceItem;
import dev.veranderter.item.custom.MetalDetectorItem;
import dev.veranderter.item.custom.ModArmorItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(CUtils.MOD_ID, name), item);
    }

    public static void registerModItems() {
        CUtils.LOGGER.info("Registering Mod Items for " + CUtils.MOD_ID);
